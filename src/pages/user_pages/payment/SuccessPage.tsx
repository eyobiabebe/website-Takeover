...
const SuccessPage = () => {
  ...
  useEffect(() => {
    console.log(title,"Redirecting to dashboard...");
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 px-4">
      <div className="bg-white shadow-xl rounded-2xl p-8 max-w-md w-full text-center">
        ...
        <div className="flex justify-center mb-6">
          <CheckCircle className="text-emerald-500 w-20 h-20 animate-bounce" />
        </div>

        {/* Title */}
        <h1 className="text-2xl font-bold text-emerald-700 mb-3">
          {title == 'listing_fee' ? 'Listing Fee' : 'Takeover Fee'} Payment Successful!
        </h1>

        {/* Message */}
        <p className="text-gray-600 mb-8">
          Thank you for your payment. Your transaction has been completed
          successfully. You can now proceed to access your service or return to
          the dashboard.
        </p>
